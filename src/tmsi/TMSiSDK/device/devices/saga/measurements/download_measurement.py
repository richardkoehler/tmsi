...
class DownloadMeasurement(SignalMeasurement):
    ...
    def start(self):
        ...
        TMSiLoggerActivity().log(f"{self.get_name()}->>SAGA-SDK: set device download request ON")
    ...
    def stop(self):
        ...
        TMSiLoggerActivity().log(f"{self.get_name()}->>SAGA-SDK: set device download request OFF")
