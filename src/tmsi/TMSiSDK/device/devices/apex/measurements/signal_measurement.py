...
class SignalMeasurement(TMSiMeasurement):
    ...
    def start(self):
        ...
        TMSiLoggerActivity().log(f"{self.get_name()}->>APEX-SDK: set device sampling request ON")
    ...
    def stop(self):
        ...
        TMSiLoggerActivity().log(f"{self.get_name()}->>APEX-SDK: set device sampling request OFF")
        self._dev.set_device_sampling_request(measurement_request)
