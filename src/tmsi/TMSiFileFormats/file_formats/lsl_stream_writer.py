...
class LSLConsumer:
    ...
    def __init__(self, lsl_outlet, time_func):
    ...
    def put(self, sd):
        ...
        try:
            ...
            signals = [
                sd.samples[i * sd.num_samples_per_sample_set : (i + 1) * sd.num_samples_per_sample_set]
    ...
    def open(self, device):
        ...
        try:
            ...
            for idx, ch in enumerate(self.device.get_device_active_channels()):  # active channels
                ...
                if (ch.get_channel_type().value == ChannelType.UNI.value) and ch.get_channel_name() != "CREF":
