...
class TMSiDevFullStatReport(Structure):
    ...
    _fields_ = [
        ...
        (
            "KeepAliveTimeout",
            c_short,
        ),  # DR Idle powerdown in sec. -1 disabled.
...
class TMSiDevChDesc(Structure):
    ...
    _fields_ = [
        ...
        (
            "ImpDivider",
            c_short,
        ),  # -1 disabled, else BaseSampleRate>>ImpDivider
        (
            "ChannelBandWidth",
            c_int,
...
class TMSiDevSampleReq(Structure):
    ...
    _fields_ = [
        ...
        (
            "DisableRepairLogging",
            c_ushort,
        ),  # Ignore the Repairlogging for now.
        (
            "DisableAvrRefCalc",
            c_ushort,
...
class TMSiDevRecCfg(Structure):
    ...
    _fields_ = [
        ...
        (
            "InitIdentifier",
            c_int,
        ),  # Identifier can be used by the application.
        (
            "PrefixFileName",
            c_byte * 16,
...
class TMSiDevSetDiagStat(Structure):
    ...
    _fields_ = [
        ...
        (
            "DRResetLog",
            c_ushort,
        ),  # Reset the logfile, old loggings are erased.
        (
            "DSLoggingState",
            c_ushort,
        ),  # Set logging state of device, 0=disable, 1= enable.
...
class TMSiFWHeaderFile(Structure):
    ...
    _fields_ = [
        ...
        (
            "FWSize",
            c_uint,
        ),  # The total size in bytes of the firmware to flash.
